function create_supplemental_figures()
%
...
base_folder = [root_folder, filesep, 'results', filesep, 'aggregate'];
...
for i = 1 : numel(names)
    ...
    xbounds = xlim;
    if i == 2 % for laserpower series redefine range
        xbounds = [10 80];
    end
